...
export default function InputLog({label, value, setValue, required,onKeyDown,placeholder}:{label:string, value:string|undefined, setValue:(value:string|undefined) => void, required?:boolean,onKeyDown?:()=>void,placeholder?:string}) {
    return (

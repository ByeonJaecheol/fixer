        ...
        <div className="flex flex-wrap gap-x-4">
          {categories.map((category : IHistoryCategory) => (
            <Link
              key={category.id}
              href={category.href}
              className="group flex-shrink-0 flex flex-col items-center p-2 md:p-4 border-b-2 border-transparent hover:border-blue-500 focus:outline-none focus:border-blue-500 transition-colors duration-200"
            >

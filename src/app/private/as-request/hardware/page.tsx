          ...
          <div className="overflow-x-auto">
            <div className="inline-block min-w-full">
              ...
              <div className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">작성자</div>
                ...
                <div className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">보안코드</div>
                <div className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">신규코드</div>
                ...
                {asManagementLog.map((log: IHardWareLog) => (
                  ...
                  {/* 사용자 */}
                    ...
                    {/* 제조번호*/}
                    <div className="px-2 py-4 text-sm text-gray-500 text-center">{log.serial_number ?? '-'}</div>
                    {/* 기존코드 */}
                    <div className="px-2 py-4 text-sm text-gray-500 text-center">{log.security_code ?? '-'}</div>
                    {/* 신규코드 */}
                    <div className="px-2 py-4 text-sm text-gray-500 text-center">{log.new_security_code ?? '-'}</div>
                  {/* 문의내용 */}

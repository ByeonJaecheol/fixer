...
export default async function SoftwarePage() {
    const gridStyle = {
       gridTemplateColumns: "8% 8% 8% 8% 12% 6% 6% 15% 15%"
          ...
          <div className="overflow-x-auto">
            <div className="inline-block min-w-full">
              ...
              <div className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">ID</div>
                ...
                <div className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">상세</div>
                ...
                {asManagementLog.map((log: IHardWareLog) => (
                  <Link 
                    href={`/private/as-request/device/detail/${log.log_id}`}
                    key={log.log_id}
                    style={gridStyle}
